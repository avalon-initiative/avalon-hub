// Shared flat config (ESLint 9+) for every package in this workspace
// (apps/hub, apps/hub-app): a single root config, picked up by `eslint .` run
// from the root or from either app's directory.
